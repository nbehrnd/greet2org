...
[[https://github.com/vscode-org-mode/vscode-org-mode][Visual Studio Code]].  Equally see Karl Voit's compilation of tools
supporting Orgmode markup [[https://gitlab.com/publicvoit/orgdown/-/blob/master/doc/Tool-Support.org?ref_type=heads][here]].
...
other backends /to build/ a wheel the [[https://packaging.python.org/en/latest/guides/writing-pyproject-toml/][Python Packaging User Guide]]
describes, only [[https://pypi.org/project/uv/][uv]] was tested.  Note the names of the workflows to
include the string =pip=, or =uv=, respectively.

Most of the workflows of this project act / can be launched
individually of each other.  With =CICD_publish_wheel.yml= one
workflow combines building a wheel (including the translation of the
=.org= to =.md=) and subsequent publication on test.pypi.org.  This is
to be lauched manually.
