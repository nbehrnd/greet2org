...
backends the [[https://packaging.python.org/en/latest/guides/writing-pyproject-toml/][Python Packaging User Guide]] describes ([[https://pypi.org/project/hatchling/][hatchling]], [[https://pypi.org/project/flit/][flit]],
[[https://pypi.org/project/pdm/][pdm]], uv-build of [[https://pypi.org/project/uv/][uv]]) are not yet tested.
